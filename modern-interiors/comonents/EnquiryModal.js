...
export default function EnquiryModal({ Openmodel,setOpenmodel }) {
  return (
    <Dialog open={Openmodel} PaperProps={{ sx:{backgroundColor:'#383636',borderRadius:'30px',}}} >
        <div
          style={{
            display: "flex",
            alignItems: "center",
        ...
        >
          ...
          <div style={{ background: "#383636" }} className="w-[100%]">
            <form
              style={{
                background: "#383636",
                display: "flex",
            ...
            >
              <div
                style={{ background: "#383636", margin: "10px 0px" }}
